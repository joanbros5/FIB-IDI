...
QT_MOC_LITERAL(1, 11, 13), // "returnPressed"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 12) // "tractaReturn"

    },
    "MyLineEdit\0returnPressed\0\0tractaReturn"
};
...
void MyLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyLineEdit::returnPressed)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyLineEdit::returnPressed(const QString & _t1)
{
